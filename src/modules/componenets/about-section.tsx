...
export const AboutSection = () => {
  return (
    <div
      id="container"
      className="h-[100svh] flex items-center justify-center p-4 py-4 pb-[250px]"
    >
      <div
        id="wrapper"
      ...
      >
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-36">
          ...
          <div className="md:w-1/2 text-center md:text-left">
            <p data-aos="fade-down" className="text-lg leading-relaxed mb-4">
              Hello! I am{" "}
            ...
            <p data-aos="fade-left" className="text-lg leading-relaxed mb-4">
              Currently, as a{" "}
              <span className="font-semibold text-[#af76c4]">
