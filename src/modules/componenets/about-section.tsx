...
export const AboutSection = () => {
  return (
    ...
    >
      ...
      >
        <h2 data-aos="fade-up" className="text-4xl sm:text-5xl font-bold text-center text-[#af76c4] mb-20">
          About Me
        </h2>
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-36">
          <div data-aos="fade-right" className="hidden md:w-1/2 md:flex justify-center">
            {/* Placeholder image for a professional headshot or icon */}
            <Image
              width={192} // Changed from 48 to 192
              height={192} // Changed from 48 to 192
              src={"/file.svg"}
              alt="Graylen Bigelow"
          ...
          <div className="md:w-1/2 text-center md:text-left">
            <p data-aos="fade-down" className="text-sm md:text-lg leading-relaxed mb-4">
              Hello! I am{" "}
            ...
            <p data-aos="fade-left" className="text-sm md:text-lg leading-relaxed mb-4">
              Currently, as a{" "}
              <span className="font-semibold text-[#af76c4]">
            ...
            <p data-aos="fade-up" className="text-sm md:text-lg leading-relaxed">
